    ...
    <section className='hero '>
      ...
      md:px-[50px] xl:px--[80px]">
        <div className="left flex flex-col gap-5">
          ...
          <p className='text-2xl my-7 px-1 dark:text-slate-300 items-center'>
            CodeBook is the world&apos;s most popular and authoritative source for computer science ebooks. 
            Find ratings and access to the newest books digitally.
          </p>

          <Link to="/products">
          <button className='w-fit bg-blue-700 py-2 px-4 text-white dark:text-slate-300 rounded-md hover:bg-blue-900 
